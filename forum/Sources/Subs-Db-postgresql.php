...
if (!defined('SMF')) {
    die('Hacking attempt... in '.__FILE__.' at l.'.__LINE__);
}
...
if (!function_exists("db_fatal_error")){
...
function smf_db_query($identifier, $db_string, $db_values = array(), $connection = null)
{
	...
	if (empty($modSettings['disableQueryCheck']) && strpos($db_string, '\'') !== false && empty($db_values['security_override']))
		smf_db_error_backtrace('Hacking attempt... in '.__FILE__.' at l.'.__LINE__, 'Illegal character (\') used in query...', true, __FILE__, __LINE__);
	...
	if (empty($modSettings['disableQueryCheck'])) {
		...
		if (!empty($fail) && function_exists('log_error'))
			smf_db_error_backtrace('Hacking attempt... in '.__FILE__.' at l.'.__LINE__, 'Hacking attempt... in '.__FILE__.' at l.'.__LINE__ . "\n" . $db_string, E_USER_ERROR, __FILE__, __LINE__);
	}

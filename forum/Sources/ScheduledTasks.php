...
if (!defined('SMF'))
	die('Hacking attempt... ScheduledTask');
...
function scheduled_countPost() {

    global $smcFunc;

    $smcFunc['db_query']('',
        'UPDATE {db_prefix}members
                  SET posts = ( SELECT COUNT(msg.id_msg)
                                FROM {db_prefix}boards brd INNER JOIN {db_prefix}messages msg ON brd.id_board=msg.id_board
                                WHERE brd.count_posts=0 AND msg.id_member={db_prefix}members.id_member)'
    );

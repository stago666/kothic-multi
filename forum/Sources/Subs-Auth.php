...
function setLoginCookie($cookie_length, $id, $password = '')
{
	...
	setcookie($cookiename, $data, time() + $cookie_length, "/", $cookie_url[0], !empty($modSettings['secureCookies']));
...
function adminLogin()
{
	...
	trigger_error('Hacking attempt... in '.__FILE__.' at l.'.__LINE__, E_USER_ERROR);
}

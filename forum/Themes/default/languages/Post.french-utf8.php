...
$txt['excamation_point'] = 'Point d\'exclamation';
$txt['question_mark'] = 'Point d\'interrogation';
$txt['lamp'] = 'Lampe';
$txt['add_smileys'] = 'Ajouter des smileys';
$txt['flash'] = 'Insérer une animation Flash';
$txt['ftp'] = 'Insérer un lien FTP';
$txt['image'] = 'Insérer une image';
$txt['table'] = 'Insérer un tableau';
$txt['table_td'] = 'Insérer une colonne de tableau';
$txt['topic_notify_no'] = 'Aucun sujet avec notification.';
$txt['marquee'] = 'Mouvement';
$txt['teletype'] = 'Télétypé';
$txt['strike'] = 'Barré';
$txt['glow'] = 'Surbrillance';
$txt['shadow'] = 'Ombré';
$txt['preformatted'] = 'Texte préformaté';
$txt['left_align'] = 'Aligné à gauche';
$txt['right_align'] = 'Aligné à droite';
$txt['superscript'] = 'Exposant';
$txt['subscript'] = 'Indice';
$txt['table_tr'] = 'Insérer une ligne de tableau';
$txt['post_too_long'] = 'Votre message est trop long. Merci de le raccourcir avant de l\'envoyer de nouveau.';
$txt['horizontal_rule'] = 'Ligne horizontale';
$txt['font_size'] = 'Taille du texte';
$txt['font_face'] = 'Police du texte';

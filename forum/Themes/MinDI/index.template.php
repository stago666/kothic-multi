...
<head>';
	...
	// Let's add some buttonlist styles, we don't want people to get confused
	echo '
...
function template_menu()
{
	...
	echo '
		...
		echo !empty($settings['forum_width']) ? '
			<div id="menuwrapper" style="width: ' . $settings['forum_width'] . '">' : '', '';
...
function MinDI()
{
	$MD = 'Design by <a href="http://www.simplemachines.org/community/index.php?action=profile;u=312371" target="_blank">buhthc</a> | Theme by <a href="http://smfhispano.net" target="_blank">Diego Andr&eacute;s</a>';	

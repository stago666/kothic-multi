...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		<table class="table_list tb-boards">
			...
			{
				echo '
				<tr id="board_', $board['id'], '" class="windowbg2 sh_boards">
	...
	<div id="posting_icons" class="floatleft">';
		...
		echo '
		<ul class="reset">'.
			'<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'new_some.gif" alt="" /> ', $txt['new_posts'], '</li>'.
			'<li class="floatleft"><img src="', $settings['images_url'], '/', $context['theme_variant_url'], 'new_some2.gif" alt="" /> ', $txt['new_posts2'], '</li>'.
